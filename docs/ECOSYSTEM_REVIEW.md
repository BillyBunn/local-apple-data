...
- Whether future write support after the approved Reminders, iCloud Drive create/append-text, Calendar, Contacts, Notes, Mail draft, and Photos import tranches should prioritize Notes append/update, Mail send, Messages send, Photos edit/delete/album support, or richer framework-backed edits.
